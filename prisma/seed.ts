...
const leaders = [
  { name: "Navin Gupta", role: "President", order: 1, associationName: "Bihar IT Association", stateName: "Bihar", category: "national", term: "2024–2026", isCurrent: true, bio: "Leading the federation with a focus on advocacy, policy engagement, and empowering channel partners across every state in India.", focusAreas: "Policy Advocacy,National Strategy,Government Relations" },
  { name: "Liju P. Raju", role: "Senior Vice President", order: 2, associationName: "Kerala IT Dealers Association", stateName: "Kerala", category: "national", term: "2024–2026", isCurrent: true, bio: "Oversees the Southern and Western zones, strengthening ties between state associations and driving regional membership growth.", focusAreas: "Regional Coordination,Membership Growth" },
  { name: "Rajeev Chitkara", role: "Vice President", order: 3, associationName: "Punjab Computer Dealers Association", stateName: "Punjab", category: "national", term: "2024–2026", isCurrent: true, bio: "Champions training and skill-development programs that keep channel partners competitive in a fast-changing market.", focusAreas: "Skill Development,Training Programs" },
  { name: "Amit Kumar", role: "Secretary General", order: 4, associationName: "Delhi IT Traders Association", stateName: "Delhi", category: "national", term: "2024–2026", isCurrent: true, bio: "Manages the federation's day-to-day administration, correspondence, and coordination across all 29 state associations.", focusAreas: "Administration,Correspondence" },
  { name: "Suresh Menon", role: "Treasurer", order: 5, associationName: "Karnataka IT Dealers Association", stateName: "Karnataka", category: "national", term: "2024–2026", isCurrent: true, bio: "Oversees FAIITA's finances, membership dues, and budget planning to keep the federation on solid financial footing.", focusAreas: "Finance,Budget Planning" },
  { name: "Priya Sharma", role: "Joint Secretary", order: 6, associationName: "Maharashtra IT Dealers Association", stateName: "Maharashtra", category: "national", term: "2024–2026", isCurrent: true, bio: "Supports the Secretary General's office and coordinates communication between the GB and state-level leadership.", focusAreas: "Communication,Coordination" },
  { name: "Vikram Reddy", role: "Executive Member", order: 7, associationName: "AP Computer Dealers Association", stateName: "Andhra Pradesh", category: "national", term: "2024–2026", isCurrent: true, bio: "Represents the interests of Southern-zone member associations on the Governing Body's executive council.", focusAreas: "Southern Zone,Executive Council" },
  { name: "Manoj Verma", role: "Executive Member", order: 8, associationName: "UP IT Traders Welfare Association", stateName: "Uttar Pradesh", category: "national", term: "2024–2026", isCurrent: true, bio: "Represents the interests of Northern-zone member associations on the Governing Body's executive council.", focusAreas: "Northern Zone,Executive Council" },
];

// Previous Governing Body — FAIITA's GB serves a 2-year term.
const pastLeaders = [
  { name: "REPLACE ME (Past President)", role: "President", order: 1, associationName: "Maharashtra IT Dealers Association", stateName: "Maharashtra", category: "national", term: "2022–2024", isCurrent: false, bio: "Led the federation's 2022–2024 term, focused on expanding state-level coverage and GST advocacy.", focusAreas: "GST Advocacy,State Expansion" },
  { name: "REPLACE ME (Past Sr. VP)", role: "Senior Vice President", order: 2, associationName: "Tamil Nadu IT Traders Association", stateName: "Tamil Nadu", category: "national", term: "2022–2024", isCurrent: false, bio: "Oversaw regional coordination during the 2022–2024 term.", focusAreas: "Regional Coordination" },
  { name: "REPLACE ME (Past VP)", role: "Vice President", order: 3, associationName: "West Bengal IT Traders Association", stateName: "West Bengal", category: "national", term: "2022–2024", isCurrent: false, bio: "Supported training and skill-development initiatives during the 2022–2024 term.", focusAreas: "Training Programs" },
  { name: "REPLACE ME (Past Secretary)", role: "Secretary General", order: 4, associationName: "Karnataka IT Dealers Association", stateName: "Karnataka", category: "national", term: "2022–2024", isCurrent: false, bio: "Managed federation administration during the 2022–2024 term.", focusAreas: "Administration" },
  { name: "REPLACE ME (Past Treasurer)", role: "Treasurer", order: 5, associationName: "Gujarat Electronics & IT Association", stateName: "Gujarat", category: "national", term: "2022–2024", isCurrent: false, bio: "Oversaw federation finances during the 2022–2024 term.", focusAreas: "Finance" },
];
