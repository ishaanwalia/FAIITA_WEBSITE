...
const states: StateSeed[] = [
  ...
  { stateName: "Himachal Pradesh", stateCode: "HP", region: "North", associationName: "Shimla I T Dealer Association (SITDA)", foundedYear: 2010, memberCount: 90, city: "Shimla", mapX: 39, mapY: 17, presidentName: "Mehar Sharma", contactEmail: "mehar_xyz@yahoo.co.in", secretaryEmail: "kuldeep@globalestore.in", logoSlug: "sitda.jpg", description: [
    "The SITDA Association, established in 2010, is a recognized body of IT and Electronics dealers and professionals in Himachal Pradesh. With a strong network of 90 active members, SITDA works at both the state and national level to unite dealers, address industry challenges, and promote sustainable growth.\n\nBeyond business, SITDA remains socially active, contributing to community initiatives and strengthening dealer solidarity across regions.",
  ...
  { stateName: "Chandigarh", stateCode: "CH", region: "North", associationName: "Technology Solution Providers Association (TECSPA)", foundedYear: 2014, memberCount: 22, city: "Chandigarh", mapX: 34, mapY: 21, presidentName: "Satpal Singh", contactPhone: "+91 94172 18200", contactEmail: "president@tecspa.in", secretaryEmail: "gensecy@tecspa.in", websiteUrl: "https://tecspa.in/", logoSlug: "tecspa.jpg", description: [
  ...
  { stateName: "Delhi", stateCode: "DL", region: "North", associationName: "All Delhi Computer Traders Association (Regd.) — ADCTA", foundedYear: 1990, memberCount: 2500, city: "New Delhi", mapX: 37, mapY: 25, presidentName: "Mahinder Agrawal", contactPhone: "+91 92121 27937", contactEmail: "adcta.nehruplace@gmail.com", secretaryEmail: "broadwaydelhi@gmail.com", websiteUrl: "https://www.adcta.com", address: "Nehru Place, New Delhi", logoSlug: "adcta.jpg", description: "All Delhi Computer Traders Association (Regd.) (ADCTA) is one of India's oldest and most respected associations representing the IT trade and computer business community. Established in 1990 with the vision of uniting computer dealers, distributors, retailers, importers, manufacturers and service providers, ADCTA has been dedicated to protecting the interests of the IT industry while promoting ethical business practices and sustainable growth.\n\nWith its registered office in Nehru Place, New Delhi — one of India's largest IT hardware markets — ADCTA has played a significant role in strengthening the computer and information technology trade across Delhi and the NCR. For over three decades, ADCTA has worked closely with government departments, industry leaders, technology brands and business stakeholders to address trade-related issues, advocate for fair business policies and create a transparent and progressive business environment. The association represents a network of around 2,500 IT businesses and professionals." },
  { slug: "delhi-cmda", stateName: "Delhi", stateCode: "DL", region: "North", associationName: "Computer Media Dealers Association, Delhi (CMDA-Delhi)", foundedYear: 2002, memberCount: 150, city: "New Delhi", mapX: 37, mapY: 25, presidentName: "Puneet Singhal", contactPhone: "+91 98100 48176", contactEmail: "infocmda@gmail.com", logoSlug: "cmda-delhi.webp", description: "The Computer Media Dealers Association, Delhi (CMDA-Delhi) is a premier information and communications technology (ICT) trade association representing IT channel partners, retailers, manufacturers, and distributors across Delhi. Founded and registered in 2002, the association acts as a unified voice to promote ethical business practices, protect dealer interests, and drive growth in the regional IT hardware and consumables sector." },
  { slug: "delhi-pcait", stateName: "Delhi", stateCode: "DL", region: "North", associationName: "Progressive Channels Association Of Information Technology (PCAIT)", foundedYear: 2005, memberCount: 200, city: "New Delhi", mapX: 37, mapY: 25, presidentName: "Alok Gupta", contactPhone: "+91 98101 98881", contactEmail: "president@pcait.in", secretaryEmail: "secretary@pcait.in", websiteUrl: "https://www.pcait.in/", logoSlug: "pcait.webp", description: [
  ...
  { stateName: "Rajasthan", stateCode: "RJ", region: "North", associationName: "Rajasthan Computer Traders Association (RCTA)", foundedYear: 2001, memberCount: 360, city: "Jaipur", mapX: 26, mapY: 31, presidentName: "Sugriv Singh", contactPhone: "+91 94140 72413", contactEmail: "rctajaipur2025@gmail.com", secretaryEmail: "frontlinejaipur@gmail.com", websiteUrl: "https://www.rctaonline.in", logoSlug: "rcta.jpg", description: [
  ...
  { slug: "rajasthan-ucta", stateName: "Rajasthan", stateCode: "RJ", region: "North", associationName: "Udaipur Computer Traders Association (Regd.) (UCTA)", foundedYear: 2006, memberCount: 180, city: "Udaipur", mapX: 26, mapY: 31, presidentName: "Ajay Srivastava", contactPhone: "+91 98290 42643", contactEmail: "President@ucta.org.in", secretaryEmail: "info@ucta.org.in", websiteUrl: "https://www.ucta.org.in", logoSlug: "ucta.png", description: "Udaipur Computer Traders Association (Regd.), popularly known as UCTA, was founded in the year 2006. UCTA is a Computer Trade Association whose members are committed to setting and maintaining the highest technical and ethical standards in the independent provision of specialist computer-related services. By independent we mean \"free to trade within the law without being obliged to acknowledge the authority, control or influence of any third party\"." },
  ...
  { stateName: "Odisha", stateCode: "OR", region: "East", associationName: "Information Technology Association Of Orissa (ITAO)", foundedYear: 1998, memberCount: 400, city: "Bhubaneswar", mapX: 55, mapY: 47, presidentName: "Abhinash Patnayak", contactPhone: "+91 98610 63215", contactEmail: "president@itaoodisha.org", secretaryEmail: "secretary@itaoodisha.org", websiteUrl: "https://www.itaoodisha.org", logoSlug: "itao.webp", description: [
  ...
  { stateName: "North East", stateCode: "AS", region: "East", associationName: "North East Computer Traders Association (NECTA)", foundedYear: 2001, memberCount: 210, city: "Guwahati", mapX: 70, mapY: 29, presidentName: "Ranjan Kumar Das", contactPhone: "+91 94351 18986", contactEmail: "president@necta.co.in", secretaryEmail: "secretary@necta.co.in", websiteUrl: "https://www.necta.co.in", logoSlug: "necta.png", address: "Guwahati, Assam", description: [
  ...
  { slug: "madhya-pradesh-mpctas", stateName: "Madhya Pradesh", stateCode: "MP", region: "Central", associationName: "Malwa Personal Computer Telecom Association (MPCTA)", foundedYear: 2011, memberCount: 205, city: "Indore", mapX: 38, mapY: 41, presidentName: "Rakesh Daga", contactPhone: "+91 93032 88083", contactEmail: "rakeshdaga1@gmail.com", secretaryEmail: "neeraj@mittalinfotech.com", websiteUrl: "https://mpcta.in", logoSlug: "mpcta.jpg", description: [
  ...
  { slug: "maharashtra-cmda-pune", stateName: "Maharashtra", stateCode: "MH", region: "West", associationName: "Computers & Media Dealers Association, Pune (CMDA)", foundedYear: 1992, memberCount: 377, city: "Pune", mapX: 30, mapY: 54, presidentName: "Mahesh More", contactPhone: "+91 98220 44158", contactEmail: "president@cmdapune.org", websiteUrl: "https://cmdapune.org/", logoSlug: "cmda-pune.webp", description: [
  ...
  { slug: "maharashtra-can", stateName: "Maharashtra", stateCode: "MH", region: "West", associationName: "Computer Association Nashik (CAN)", foundedYear: 1998, memberCount: 180, city: "Nashik", mapX: 30, mapY: 54, presidentName: "Sharad Mishra", contactPhone: "+91 98230 55584", contactEmail: "info@canit.co.in", websiteUrl: "https://www.canit.co.in", logoSlug: "can.webp", description: "Computer Association Nashik (CAN) is a professional organization formed to support and promote the IT industry in Nashik. It brings together developers, entrepreneurs, and IT companies on a common platform.\n\nWe aim to encourage collaboration, knowledge sharing, and business growth within the technology sector. CAN plays a vital role in building a strong IT ecosystem in the region.\n\nOur association continuously works towards empowering professionals through events, training, and networking opportunities." },
  ...
  // — South —
  { stateName: "Andhra Pradesh", stateCode: "AP", region: "South", associationName: "Computer Dealers Association of Nellore District (CDAN)", foundedYear: 2011, memberCount: 55, city: "Nellore", mapX: 46, mapY: 64, presidentName: "B.V. Deepak", contactPhone: "+91 98481 75765", contactEmail: "president@cdan.com", secretaryEmail: "secretary@cdan.com", logoSlug: "cdan.webp", description: [
  ...
  { stateName: "Tamil Nadu", stateCode: "TN", region: "South", associationName: "Confederation of Information Technology Associations (CONFED-ITA)", foundedYear: 2007, memberCount: 1900, city: "Chennai", mapX: 39, mapY: 84, presidentName: "Vasudevan", contactPhone: "+91 99444 40980", contactEmail: "president@confedita.co.in", secretaryEmail: "secretary@confedita.co.in", websiteUrl: "https://www.confedita.co.in", logoSlug: "confed.jpeg", description: [
