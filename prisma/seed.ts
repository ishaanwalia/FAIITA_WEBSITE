...
const states: StateSeed[] = [
  ...
  { stateName: "Uttarakhand", stateCode: "UT", region: "North", associationName: "Uttarakhand IT Trade Association (UITTA)", foundedYear: 2001, memberCount: 120, city: "Dehradun", mapX: 43, mapY: 20, contactEmail: "president@uitta.org", logoSlug: "uitta.png", description: "UITTA is a group of individuals who come together with a shared vision and common purpose established in year 2001. We as UITTA promotes unity, cooperation and support to their members and also collective efforts for the betterment of our members." },
