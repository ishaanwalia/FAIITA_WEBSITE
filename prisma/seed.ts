...
const states: StateSeed[] = [
  ...
  { stateName: "Himachal Pradesh", stateCode: "HP", region: "North", associationName: "Shimla I T Dealer Association (SITDA)", foundedYear: 2010, memberCount: 90, city: "Shimla", mapX: 39, mapY: 17, presidentName: "Mehar Sharma", contactEmail: "info@sitda.in", secretaryEmail: "kuldeep@globalestore.in", logoSlug: "sitda.jpg", description: [
