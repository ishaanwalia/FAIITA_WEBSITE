...
const ORBS: Record<MeshVariant, { className: string; delay?: string }[]> = {
  ...
  dawn: [
    ...
    { className: "-right-20 -top-20 h-72 w-72 bg-sky-400/15 blur-[100px]", delay: "2s" },
    { className: "-left-16 top-1/4 h-64 w-64 bg-navy-500/30 blur-[90px]", delay: "3.5s" },
  ],
  tide: [
    { className: "-left-32 top-1/4 h-96 w-96 bg-sky-400/15 blur-[100px]" },
    { className: "-right-32 top-1/2 h-96 w-96 bg-navy-500/35 blur-[100px]", delay: "1.5s" },
  ...
  ember: [
    ...
    { className: "-top-20 left-[15%] h-72 w-72 bg-saffron-400/10 blur-[90px]", delay: "2s" },
    { className: "left-1/2 top-1/2 h-80 w-80 bg-navy-500/30 blur-[110px]", delay: "3.5s" },
  ],
  meadow: [
    ...
    { className: "-bottom-16 right-1/3 h-72 w-72 bg-navy-500/30 blur-[90px]", delay: "3s" },
  ],
  zenith: [
    { className: "-top-40 left-1/2 h-[30rem] w-[30rem] -translate-x-1/2 bg-saffron-500/15 blur-[120px]" },
    { className: "-bottom-12 -left-24 h-72 w-72 bg-navy-500/35 blur-[100px]", delay: "2s" },
    { className: "-bottom-12 -right-24 h-72 w-72 bg-federal-green/[0.12] blur-[100px]", delay: "3.5s" },
  ],
};
