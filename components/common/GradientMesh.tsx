 ...
 */
/**
 * Tricolour Ink allows exactly three hues: orange (the accent), federal green
 * (the tricolour tertiary) and slate/ink (the ground). The variants differ by
 * *placement and weighting* of those three, not by introducing new colours —
 * the violet/teal/cyan these used to carry aren't in the palette.
 */
const ORBS: Record<MeshVariant, { className: string; delay?: string }[]> = {
  ...
  dawn: [
    ...
    { className: "-right-20 -top-20 h-72 w-72 bg-saffron-400/12 blur-[100px]", delay: "2s" },
    { className: "-left-16 top-1/4 h-64 w-64 bg-navy-400/20 blur-[90px]", delay: "3.5s" },
  ],
  tide: [
    { className: "-left-32 top-1/4 h-96 w-96 bg-navy-400/20 blur-[100px]" },
  ...
  ember: [
    ...
    { className: "-top-20 left-[15%] h-72 w-72 bg-saffron-600/12 blur-[90px]", delay: "2s" },
  ...
  meadow: [
    ...
    { className: "-bottom-16 right-1/3 h-72 w-72 bg-navy-400/20 blur-[90px]", delay: "3s" },
  ],
  zenith: [
    { className: "-top-40 left-1/2 h-[30rem] w-[30rem] -translate-x-1/2 bg-navy-400/[0.22] blur-[120px]" },
    { className: "-bottom-12 -left-24 h-72 w-72 bg-saffron-500/18 blur-[100px]", delay: "2s" },
    { className: "-bottom-12 -right-24 h-72 w-72 bg-federal-green/[0.14] blur-[100px]", delay: "3.5s" },
  ],
};
