 ...
 */
/**
 * Orange leads every variant — it is the accent and nothing else competes with
 * it for that job. Each variant then pairs it with one cool hue (violet, teal
 * or the brightened federal green) placed away from the orange, because a
 * single warm hue over ink reads flat: there is nowhere for the eye to fall
 * away to. The cool orbs sit at roughly half the orange's opacity and never
 * carry text or a control.
 */
