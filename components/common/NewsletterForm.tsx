  ...
  return (
    <form onSubmit={onSubmit} className="flex gap-2">
      ...
      <input
        ...
        className="w-full min-w-0 rounded-full border border-white/15 bg-white/5 px-4 py-3 text-base text-white placeholder:text-white/40 focus:border-saffron-400 focus:outline-none"
      />
